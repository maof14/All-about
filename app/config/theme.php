...
return [
     ...
     */
    'views' => [
        ['region' => 'header', 'template' => 'project/header', 'data' => ['siteTitle' => 'Allt om Excel', 'siteTagline' => 'Ännu en sida från WGTOTW'], 'sort' => -1],
        ['region' => 'footer', 'template' => 'project/footer', 'data' => [], 'sort' => -1],
        [ // navbar
            'region' => 'navbar', 
            'template' => [
                'callback' => function() {
